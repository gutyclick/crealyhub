...
export function planContent(provider: AIProvider, brand: BrandContext, recent: unknown, count: number, request?: string) {
  return provider.generateStructured({ operation:"content_plan", model:env.OPENAI_STRATEGY_MODEL,
    ...
    instructions:"Actúa como estratega editorial senior. Prioriza intención, variedad y utilidad. Evita repetir temas, hooks y CTA recientes. Los porcentajes editoriales son objetivos flexibles. Devuelve únicamente el resultado estructurado.",
